...
//    
//    
////    char temp;// = new char[encoded_fragment_len];
////    for(int i = 0; i < encoded_fragment_len; i++){
////        temp = (*(encoded_data + 3 * encoded_fragment_len))[i];
////        (*(encoded_data + 3 * encoded_fragment_len))[i] = (*(encoded_data + 2 * encoded_fragment_len))[i];
////        (*(encoded_data + 2 * encoded_fragment_len))[i] = temp;
////    }
////    
//    
//    char temp;
...
//    for(int i = 0; i < encoded_fragment_len; i++){
//        temp = encoded_data[3][i]; //(*(encoded_data + 3 * encoded_fragment_len))[i];
//        encoded_data[3][i] = encoded_data[2][i];
//        encoded_data[2][i] = temp;
//        
////        if(i == 2 && i == 4 && i == 5 && i == )
////            encoded_data[2][i] = 0;
////        if(i == 20)
...
//        
//        
//        temp = encoded_data[5][i];
//        encoded_data[5][i] = encoded_data[0][i];
//        encoded_data[0][i] = temp;
//        
//    }
//    
