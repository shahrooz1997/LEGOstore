    ...
    for f_index, f in enumerate(availability_targets):
        ...
        for file_name in workload_files:
            for baseline in baselines[f_index]:
                ...
                print(str(exec_num) + ": python3 ../placement.py -f ../tests/inputtests/dc_gcp.json -i " + os.path.join(files_path,
        ...
        for file_name in workload_files:
            ...
            # print("running", result_file_name, "...")
            print(str(exec_num) + ": python3 ../placement.py -f ../tests/inputtests/dc_gcp.json -i " + os.path.join(files_path, file_name) + " -o " + os.path.join(files_path, result_file_name) + " -H min_cost -v")
