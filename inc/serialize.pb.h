...
inline void Datacenter::_internal_set_metadata_server_ip(const std::string& value) {
  ...
  metadata_server_ip_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline void Datacenter::set_metadata_server_ip(const char* value) {
  ...
  metadata_server_ip_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
...
inline void Datacenter::set_metadata_server_ip(const char* value,
  ...
  metadata_server_ip_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* Datacenter::_internal_mutable_metadata_server_ip() {
  ...
  return metadata_server_ip_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
