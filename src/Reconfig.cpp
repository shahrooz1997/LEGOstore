...
int Reconfig::start_reconfig(Properties* prop, GroupConfig& old_config, GroupConfig& new_config, std::string key,
        int old_desc, int new_desc){
...
int Reconfig::send_reconfig_query(Properties* prop, GroupConfig& old_config, std::string& key, Timestamp** ret_ts,
        std::string& ret_v){
