...
int ABD_Server::reconfig_info(const string &key, uint32_t conf_id, const Request &req, string &msg, string &recon_timestamp, Cache &cache, Persistent &persistent){
    DPRINTF(DEBUG_ABD_Server, "started.\n");
...
std::string ABD_Server::get_timestamp(string &key, uint32_t conf_id, const Request &req, Cache &cache, Persistent &persistent, std::mutex &lock_t){
...
std::string ABD_Server::put(string &key, uint32_t conf_id, string &value, string &timestamp, const Request &req, Cache &cache, Persistent &persistent, std::mutex &lock_t){
...
std::string ABD_Server::get(string &key, uint32_t conf_id, string &timestamp, const Request &req, Cache &cache, Persistent &persistent, std::mutex &lock_t){
